      ...
      <div className="relative z-10 space-y-5">
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 bg-black/40 border border-white/5 rounded-lg space-y-3">
            ...
            {/* Steps Visual */}
            <div className="grid grid-cols-3 gap-1.5 sm:gap-2 text-[9px] sm:text-[10px] font-medium text-text-secondary/60 text-center">
          ...
          <div className="p-4 bg-gradient-to-br from-accent-purple/10 to-transparent border border-accent-purple/20 rounded-lg space-y-3">
            <div className="flex justify-between items-center gap-2">
              <span className="font-bold text-accent-gold uppercase tracking-wider flex items-center gap-1.5 text-[10px] sm:text-xs">
                <Zap size={12} className="animate-bounce shrink-0" />
                <span className="leading-tight">Mercian Wealth Autonomic Engine</span>
              </span>
              <span className="text-[10px] text-accent-gold/80 flex items-center gap-1 font-bold shrink-0">
                <Clock size={10} />
                {autoStep === 0 ? "0s" : autoStep === 1 ? "4s" : autoStep === 2 ? "12s" : autoStep === 3 ? "25s" : "45s"}
              </span>
            </div>

            {/* Steps Visual */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-1 sm:gap-1.5 text-[9px] sm:text-[9px] font-bold text-text-secondary/50 text-center">
