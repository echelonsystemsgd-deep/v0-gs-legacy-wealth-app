    ...
    >
      ...
      >
        ...
        <span className="font-sans tracking-wide text-white/90 group-hover:text-white transition-colors">
          Expanding Regional Capabilities — <span className="text-accent-gold font-semibold underline decoration-accent-gold/40 underline-offset-4 group-hover:decoration-accent-gold">Explore Local Business Digital Packages</span>
        </span>
