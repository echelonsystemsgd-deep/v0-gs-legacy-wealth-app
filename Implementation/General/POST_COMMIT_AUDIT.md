...
| **Baseline Capital Realised** | **PASS** | Set baseline sales total to £40,000 + actual payments on top, and total contract value by +£40,000, isolating changes from database records. | [app/(admin)/admin/page.tsx] |
