              ...
              <div className="space-y-4">
                ...
                <div className="p-5 bg-bg-tertiary/30 border border-white/5 hover:border-accent-gold/30 rounded-xl transition-all duration-300 flex items-start gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <a href="mailto:support@localengine.ai" className="text-sm font-semibold text-white hover:text-accent-gold transition-colors font-mono">
                      support@localengine.ai
                    </a>
                  </div>
                </div>
