  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] flex items-center justify-center p-6">
      <div className="max-w-md w-full glass rounded-2xl border border-accent-gold/20 p-8 text-center space-y-5">
        ...
        <h1 className="font-serif text-xl font-bold text-foreground">Client Portal Error</h1>
        <p className="text-sm text-muted-foreground">
          We could not load this section. Please try again or contact your account manager.
        </p>
