...
const STAGES: ProjectStage[] = [
  {
    ...
    key: 'Discovery',
    subtitle: 'Systems Mapping & Logic Alignment',
    description: 'We establish foundational databases, document API requirements, and lock the system execution blueprint to map out operational logic.',
    deliverables: ['Creative Brief Completion', 'Scope of Work Approved', 'Tech & Integrations Mapped'],
  },
  {
    name: '2. UI/UX Design',
    key: 'Design',
    subtitle: 'Visual Authority Layouts',
    description: 'We architect high-fidelity visual prototype layouts in Figma to establish brand dominance and visual prestige. Zero templates.',
  ...
  },
  {
    ...
    key: 'Development',
    subtitle: 'Core Logic Engineering',
    description: 'We code custom Next.js frontend layers, configure secure database storage with Supabase RLS, and program autonomic workflow conduits.',
    deliverables: ['Next.js App Built', 'Supabase DB Configured', 'Content & Media Integrated'],
  },
  {
    name: '4. Revision & Signoff',
    key: 'Revision',
    subtitle: 'Throughput Validation & Speed Optimization',
    description: 'We deploy staging versions, audit response latency, optimize render speeds, and run thorough security and telemetry checks.',
    deliverables: ['Staging Link Live', 'Revision Loops Finished', 'SEO Audits & Optimization'],
  },
  {
    name: '5. Launch & Handoff',
    key: 'Complete',
    subtitle: 'Production Sever Routing & Handover',
    description: 'We route traffic to production domains, initialize live backup redundancies, and transfer complete administrative ownership.',
