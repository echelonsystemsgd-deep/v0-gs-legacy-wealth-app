...
export const SITE_COPY = {
  ...
  portfolioPage: {
    ...
    constructionTitle: "Request Project Case Study & Blueprint",
    constructionDescription: "Due to client confidentiality and active NDAs, we cannot expose this project's production build directly to public traffic. Enter your details to instantly receive a sanitized architectural blueprint, case study, and system walkthrough.",
