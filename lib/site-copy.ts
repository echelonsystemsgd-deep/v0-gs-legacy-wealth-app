    ...
    setupTiers: [
      {
        ...
        description: "A complete custom mobile storefront and 24/7 lead capture system with one flat upfront cost and zero recurring commitments.",
        features: [
      ...
      },
      {
        ...
        description: "Full custom storefront, custom cake/catering order builder, instant deposit collection, and active WhatsApp phone alerts.",
        features: [
          "Everything in One-Time Build",
          "Custom 3-Tap Order & Booking Builder",
          "Instant Upfront Deposit Collection",
          "Instant WhatsApp & Email Order Alerts",
          "Dedicated Ultra-Fast Managed Hosting & SSL",
      ...
      },
      {
        ...
        features: [
          ...
          "Full Workflow Automation Included",
    ...
    retainerTiers: [
      {
        ...
        features: [
          "Ultra-Fast Managed Mobile Hosting",
